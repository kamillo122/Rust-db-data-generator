...
#[tokio::main]
async fn main() {
    let mysql_url = "mysql://root@localhost:3307/test";
    let mongodb_uri = "mongodb+srv://AdminKamilo:I1udrg12@cluster0.8from.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
